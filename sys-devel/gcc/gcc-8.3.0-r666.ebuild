...
CHECKS_EXTRA="$( [ ${GCCMAJOR} -ge 8 ] && printf -- "extra" )"
...
_gcc_prepare_harden() {
	...
	[ ${GCCMAJOR} -eq 6 ] && _gcc_prepare_harden_7
	[ ${GCCMAJOR} -eq 7 ] && _gcc_prepare_harden_7
	[ ${GCCMAJOR} -eq 8 ] && _gcc_prepare_harden_8
